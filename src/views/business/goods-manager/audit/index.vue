    ...
    <el-table style="width: 100%"
      ...
      <el-table-column align="center" label="操作"  width="160">
        <template slot-scope="scope">
            ...
            <el-button size="mini" @click="handleUpdateProduct(scope.$index, scope.row)">查看</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdateProduct(index,row){
                this.$router.push({path:'/goods/goods-manager/goodsDetail',query:{id:row.id}});
            },
            ...
            handleDelete(index,row) {
                let ids=[row.id]
                this.$confirm('此操作将审核通过该spu, 是否继续?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    spuApi.auditGoods(ids).then(res => {
                        this.$message({
                            type: 'success',
                            message: '审核成功!'
                        });
